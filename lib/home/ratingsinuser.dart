...
class RatingInUser extends StatefulWidget {
  const RatingInUser({super.key});

  @override
  State<RatingInUser> createState() => _RatingInUserState();
}

class _RatingInUserState extends State<RatingInUser> {
  var rateme = "";
  String? rati = "";
  ...
  Rateee(context) async {
    ...
    map["jop_id"] = job_id;
    map["user_id"] = user_id;
    map["user_type"] = "Candidate";
    map["employer_id"] = empp_id;
