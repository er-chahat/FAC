...
class _JobapplyState extends State<Jobapply> {
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (val){
                        if(numbcontroller.text == null || numbcontroller.text.isEmpty){
              ...
              if (_formKey.currentState!.validate()) {
                if(result != null){
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text("Please upload resume to apply"),
  ...
  Applyjob(context) async {
    ...
    if (res.statusCode == 200) {
      if (jsondata["error"] == 0) {
        print("hello its your dont cotegory id get");
        Navigator.pushNamed(context, "suc");
        Future.delayed(Duration(seconds:2),(){
          //Navigator.popUntil(context, (route) => route.isFirst);
          Navigator.pop(context);
          print("hello its your dont cotegory id get");
          if(Navigator.canPop(context) && jsondata["category_id"] == null){
            print("hello its your Navigator popt");
            Navigator.pop(context);
          }
          if(jsondata["category_id"] != null && jsondata["category_id"] != "") {
            print("hello its your cotegory id get");
            Navigator.push(context, MaterialPageRoute(builder: (context) =>
                QuestionOptions(cate: jsondata["category_id"],
                    callback: callback,
                    moveResult: true,
                    job_aply_id: jsondata["user_apply_jop_id"])));
          }
